...
for i, test in enumerate(tests):
    ...
    if(dominant_class == actual_label):
        ...
        lb_fullpath = "stress_test_result/Deeppoly.csv"
        ...
        if(dominant_class == actual_label):
            ...
            #     csv_writer.writerow([net_file, str(dataset), "img "+str(i)+" with label "+str(actual_label), "eps="+str(epsilon), "deeppoly", str(end - start)+" secs", "success"])
            print("image ", i, " success!")
        else:
            # with open(lb_fullpath, 'a+', newline='') as write_obj:
            #     csv_writer = csv.writer(write_obj)
            #     csv_writer.writerow([net_file, str(dataset), "img "+str(i)+" with label "+str(actual_label), "eps="+str(epsilon), "deeppoly", str(end - start)+" secs", "fail"])
            print("image ", i, " fail!")
