...
parser.add_argument('--is_early_terminate', type=str2bool, default=False,  help='flag to allow average merging or not')
parser.add_argument('--early_termi_thre', type=int, default=0,  help='flag to allow random expression prune or not')
parser.add_argument('--is_sum_def_over_input', type=str2bool, default=False,  help='flag to allow sampling to select constraint or not')
